const requests = {
	...
	fetchMystery: {
		title: 'Mystery',
		url: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=9648`,
	},

	fetchSciFi: {
		title: 'Sci-Fi',
		url: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=878`,
	},

	fetchWestern: {
		title: 'Western',
		url: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=37`,
	},

	fetchAnimation: {
		title: 'Animation',
		url: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=16`,
	},

	fetchTV: {
		title: 'TV Movie',
		url: `/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=10770`,
	},
};
